...
A technical mod that enables The Sims 4’s hidden vanilla logging system at startup. Based on Scumbumbo's Log Enabler, now updated for modern use.

Mod to enable the TS4 vanilla logs on startup. Based on https://modthesims.info/d/606667/sims-log-enabler.html by scumbumbo.

## 🧪 Cheat Commands
Available via the in-game cheat console while the mod is running:
...
Note: All console changes are temporary and not saved to the configuration file.


## ⚙️ Configuration File
On startup, the mod generates a configuration file with the following options:
